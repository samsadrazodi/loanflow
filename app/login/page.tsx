    ...
    <div className="login-wrapper">
      <div className="login-card">
        <div style={{ textAlign: 'center', marginBottom: 6 }}>
          <svg viewBox="0 0 28 28" fill="none" style={{ width: 36, height: 36, margin: '0 auto 10px' }}><rect width="28" height="28" rx="7" fill="var(--accent-blue)"/><path d="M8 9h4v10H8V9zm5 0h2l4 10h-2.5l-0.8-2.2h-3.8L11 19h-.5L13 9zm1 1.8L12.6 15h2.8L14 10.8z" fill="white"/></svg>
        </div>
        <div className="login-title">LoanFlow</div>
        <div className="login-sub">Loan Processing Dashboard v2.0</div>
